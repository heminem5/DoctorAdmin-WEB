...
<!--        </label>-->
        ...
        <span class="el-upload-list__item-actions">
            <span v-if="isImage(file.ext)" class="el-upload-list__item-preview" @click="onPreview(file)">
...
const props = defineProps({
  /**
   * todo 包含list或者一个对象，需要包含nameField（fileName）和keyField（fileId）为key的值
